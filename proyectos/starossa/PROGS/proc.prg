...
LPARAMETERS nSecuencia
LOCAL PyI25,cCodBarra
PyI25 = CreateObject("PyI25")
IF !DIRECTORY(SYS(5)+CURDIR()+"CodBarra")
	MKDIR SYS(5)+CURDIR()+"CodBarra"
ENDIF
cCodBarra = STRTRAN(RTRIM(STRtrim(nSecuencia,12))," ","0")
cCodBarra = cCodBarra + PyI25.DigitoVerificadorModulo10(cCodBarra)
cNameArchivo = SYS(5)+CURDIR()+"CodBarra\"+strtrim(nSecuencia,12)+".jpg"
IF !FILE(cNameArchivo)
	*--formato jpg
	SET SAFETY OFF
	lok = PyI25.GenerarImagen(cCodBarra,cNameArchivo,9,0,90,"JPEG")
	SET SAFETY ON 
ENDIF 
...
DO CASE 
	...
	Create Cursor Csrpago (id i AUTOINC,numero n(3),cnombre c(25),fecha d,importe n(12,2),idcuenta n(10);
