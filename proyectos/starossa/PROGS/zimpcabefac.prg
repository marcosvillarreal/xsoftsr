...
SELECT Csrcabeza
SET FILTER TO YEAR(fecha)=2009 AND MONTH(fecha)=7
...
SCAN FOR !EOF()
	...
	ldfecha       = DATETIME(YEAR(Csrcabeza.fecha),MONTH(Csrcabeza.fecha),DAY(Csrcabeza.fecha),0,0,0)
		...
		IF CsrCabeza.perceib #0
			* IBTO1 / IBTO2
			lnidcuenta  = 18

			lnimporte   =Csrcabeza.perceib 	
	    		lctipoconce = "PB"
			...
			INSERT INTO CsrTablaimp(id,idmaopera,idcuenta,tipoconce,importe,idorigen,tablaori,idasiento,tasa,baseimp,nombre,idprovincia,detalle,nombre);
					VALUES (lnidTablaimp,lnid,lnidcuenta,lctipoconce,lnimporte,lnidorigen,lctablaori,lnidasiento,lntasa,lnbase,"",lnidprovincia,"","IBTO1")
			lnidTablaimp = lnidTablaimp + 1
		ENDIF
		...
		IF CsrCabeza.pib #0
			* IBTO1 / IBTO2
			...
			INSERT INTO CsrTablaimp(id,idmaopera,idcuenta,tipoconce,importe,idorigen,tablaori,idasiento,tasa,baseimp,nombre,idprovincia,detalle,nombre);
					VALUES (lnidTablaimp,lnid,lnidcuenta,lctipoconce,lnimporte,lnidorigen,lctablaori,lnidasiento,lntasa,lnbase,"",lnidprovincia,"","IBTO2")
			lnidTablaimp = lnidTablaimp + 1
		ENDIF
