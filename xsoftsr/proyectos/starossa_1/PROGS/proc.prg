...
Catch To loCatchErr
	...
	oavisar.usuario(' Metodo: '+loCatchErr.Procedure+CHR(13)+;
						'Mensaje: '+ALLTRIM(loCatchErr.Message)+' Nro Error ['+ALLTRIM(STR(loCatchErr.ErrorNo))+']'+CHR(13)+;
 						'Linea: '+ALLTRIM(loCatchErr.LineContents))
	lok = .f.
ENDTRY 
